...
- Wireframing, Prototyping, Design Systems, Style Guides  
- Smooth Handoffs with Component-Based Thinking
...
- SSR/SSG, Hybrid Rendering in Next.js  
- Component Architecture, State Management, Performance Optimization  
- Advanced Responsiveness (container queries, fluid typography)

### Focus Areas
- Gamification (loops, rewards, progression systems)  
- Ultra-Responsive & Accessible Web (WCAG-friendly)
